...
//
////        Line l1 = (Line) g1;
////        Line l2 = (Line) g2; //ClassCastException
//
...
//    protected int id = 1;
    ...
    public Properties(int width, String color) {
        this.width = width;
        this.color = color;
        System.out.println("конструктор Properties с двумя параметрами");
    }
...
class Line extends Properties{
    ...
    void show(){
        super.show();
        System.out.println("координаты линии - х1: " + this.x1 + ", x2:" + this.x2 + ", y1:" + this.y1 + ", y2:" + this.y2);
    }
